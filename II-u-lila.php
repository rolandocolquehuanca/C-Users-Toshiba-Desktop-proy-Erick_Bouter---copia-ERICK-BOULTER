...
<html lang="es">
	...
	<body>
			...
			<div class="wrapper">
				<div class="logo">
					<div class="nom1">
						...
						echo "Elegiste el color LILA ..." .$_SESSION['nombreUsuario'];
					?>
					</div>
					<!--<div class="nom2">
						<?php
		...
		<section id="contenedor">
			...
			<div class="bb">
				<div class="b1">
					<a href="#"onmousedown="bleep8.play()"><img src="img/bt-li-boton.png" width="30%"></a>					
					<a href="#"onmousedown="bleep9.play()"><img src="img/bt-li-cartera.png" width="30%"></a>					
					<a href="#"onmousedown="bleep10.play()"><img src="img/bt-li-cuaderno.png" width="30%"></a>					
					<a href="#"onmousedown="bleep11.play()"><img src="img/bt-li-zapato.png" width="30%"></a>					
					<a href="#"onmousedown="bleep12.play()"><img src="img/bt-li-medias.png" width="30%"></a>					
					<a href="#"onmousedown="bleep13.play()"><img src="img/bt-li-pantalon.png" width="30%"></a>
				</div>
