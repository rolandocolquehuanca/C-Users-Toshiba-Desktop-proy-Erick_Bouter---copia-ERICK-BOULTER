...
<html lang="es">
	<head>
		...
		<script>
			...
			bleep8.src="audio/globo.mp3";
		</script>
		<script>
			var bleep9=new Audio();
			bleep9.src="audio/pato.mp3";
		</script>
		<script>
			var bleep10=new Audio();
			bleep10.src="audio/sol.mp3";
		</script>
		<script>
			var bleep11=new Audio();
			bleep11.src="audio/platano.mp3";
		</script>
		<script>
			var bleep12=new Audio();
			bleep12.src="audio/pollo.mp3";
		</script>
		<script>
			var bleep13=new Audio();
			bleep13.src="audio/pollo.mp3";
		</script>
	</head>
	...
	<body>
			...
			<div class="wrapper">
				<div class="logo">
					<div class="nom1">
						...
						echo "Elegiste el color AMARILLO ..." .$_SESSION['nombreUsuario'];
					?>
					</div>
					<!--<div class="nom2">
						<?php
		...
		<section id="contenedor">
			...
			<div class="bb">
				<div class="b1">
					<a href="#"onmousedown="bleep8.play()"><img src="img/bt-am-globo.png" width="30%"></a>					
					<a href="#"onmousedown="bleep9.play()"><img src="img/bt-am-pato.png" width="30%"></a>					
					<a href="#"onmousedown="bleep10.play()"><img src="img/bt-am-sol.png" width="30%"></a>					
					<a href="#"onmousedown="bleep11.play()"><img src="img/bt-am-platano.png" width="30%"></a>					
					<a href="#"onmousedown="bleep12.play()"><img src="img/bt-am-pollo.png" width="30%"></a>					
					<a href="#"onmousedown="bleep13.play()"><img src="img/bt-am-vestido.png" width="30%"></a>
				</div>
