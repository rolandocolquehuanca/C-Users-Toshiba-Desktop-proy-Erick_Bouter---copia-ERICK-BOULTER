	...
	<body>
		...
		<section id="contenedor">
			<div class="aa">
				...
				<div class="a2">
					<img src="img/tres-rojo.png" width="100%">
				</div>
			</div>
			<div class="bb">
				<div class="b1">
					<a href="3-u-azul-0-mal.php"><img src="img/bt-azul.jpg" width="26%"></a>
					<a href="3-u-verde-0-bien.php"><img src="img/bt-verde.jpg" width="26%"></a>
					<a href="3-u-rojo-0-mal.php"><img src="img/bt-rojo.jpg" width="26%"></a>
				</div>
				</div>
				...
				<div class="b2">
					...
					<audio controls autoplay width="20%" heigth="20%">
						<source src="audio/escoge-color-verde-3.mp3">
					</audio>
					<!--<audio src="audio/1.mp3" preload="auto" controls></audio>-->
					</div>
				</div>
