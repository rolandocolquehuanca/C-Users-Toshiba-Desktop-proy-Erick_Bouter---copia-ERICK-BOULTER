	...
	<body>
		...
		<section id="contenedor">
			<div class="aa">
				...
				<div class="a2">
					<img src="img/ocho-amarillo.png" width="100%">
				</div>
			</div>
			<div class="bb">
				<div class="b1">
					<a href="8-u-azul-0-mal.php"><img src="img/bt-azul.jpg" width="26%"></a>
					<a href="8-u-naranja-0-bien.php"><img src="img/bt-naranja.jpg" width="26%"></a>
					<a href="8-u-amarillo-0-mal.php"><img src="img/bt-amarillo.jpg" width="26%"></a>
				</div>
				</div>
				...
				<div class="b2">
					...
					<audio controls autoplay width="20%" heigth="20%">
						<source src="audio/escoge-color-naranja-8.mp3">
					</audio>
					<!--<audio src="audio/1.mp3" preload="auto" controls></audio>-->
					</div>
				</div>
