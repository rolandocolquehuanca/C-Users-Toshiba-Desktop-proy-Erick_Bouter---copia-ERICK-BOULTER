	...
	<body>
			...
			<div class="wrapper">
				<div class="logo">
					<div class="nom1">
						...
						echo "No es el color lila intenta nuevamente..." .$_SESSION['nombreUsuario'];
					?>
					</div>
					<!--<div class="nom2">
						<?php
		...
		<section id="contenedor">
			<div class="aa">
				...
				<div class="a2">
					<img src="img/uno-amarillo.png" width="100%">
				</div>
			</div>
			<div class="bb">
				<div class="b1">
					<a href="1-u-amarillo-0-mal.php"><img src="img/bt-amarillo.jpg" width="26%"></a>
					<a href="1-u-rojo-0-mal.php"><img src="img/bt-rojo.jpg" width="26%"></a>
					<a href="1-u-lila-0-bien.php"><img src="img/bt-lila.jpg" width="26%"></a>
				</div>
				</div>
				...
				<div class="b2">
					...
					<audio controls autoplay width="20%" heigth="20%">
						<source src="audio/escoge-color-lila-1.mp3">
					</audio>
					<!--<audio src="audio/1.mp3" preload="auto" controls></audio>-->
					</div>
				</div>
