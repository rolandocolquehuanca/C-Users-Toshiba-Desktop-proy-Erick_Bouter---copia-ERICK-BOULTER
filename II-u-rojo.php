...
<html lang="es">
	...
	<body>
			...
			<div class="wrapper">
				<div class="logo">
					<div class="nom1">
						...
						echo "Elegiste el color ROJO ..." .$_SESSION['nombreUsuario'];
					?>
					</div>
					<!--<div class="nom2">
						<?php
		...
		<section id="contenedor">
			...
			<div class="bb">
				<div class="b1">
					<a href="#"onmousedown="bleep8.play()"><img src="img/bt-ro-frutilla.png" width="30%"></a>					
					<a href="#"onmousedown="bleep9.play()"><img src="img/bt-ro-globo.png" width="30%"></a>					
					<a href="#"onmousedown="bleep10.play()"><img src="img/bt-ro-lana.png" width="30%"></a>					
					<a href="#"onmousedown="bleep11.play()"><img src="img/bt-ro-manzana.png" width="30%"></a>					
					<a href="#"onmousedown="bleep12.play()"><img src="img/bt-ro-pelota.png" width="30%"></a>					
					<a href="#"onmousedown="bleep13.play()"><img src="img/bt-ro-polera.png" width="30%"></a>
				</div>
