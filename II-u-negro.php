...
<html lang="es">
	...
	<body>
			...
			<div class="wrapper">
				<div class="logo">
					<div class="nom1">
						...
						echo "Elegiste el color NEGRO ..." .$_SESSION['nombreUsuario'];
					?>
					</div>
					<!--<div class="nom2">
						<?php
		...
		<section id="contenedor">
			...
			<div class="bb">
				<div class="b1">
					<a href="#"onmousedown="bleep8.play()"><img src="img/bt-ne-cocina.png" width="30%"></a>					
					<a href="#"onmousedown="bleep9.play()"><img src="img/bt-ne-cucharon.png" width="30%"></a>					
					<a href="#"onmousedown="bleep10.play()"><img src="img/bt-ne-olla.png" width="30%"></a>					
					<a href="#"onmousedown="bleep11.play()"><img src="img/bt-ne-plato.png" width="30%"></a>					
					<a href="#"onmousedown="bleep12.play()"><img src="img/bt-ne-santen.png" width="30%"></a>					
					<a href="#"onmousedown="bleep13.play()"><img src="img/bt-ne-tenis.png" width="30%"></a>
				</div>
