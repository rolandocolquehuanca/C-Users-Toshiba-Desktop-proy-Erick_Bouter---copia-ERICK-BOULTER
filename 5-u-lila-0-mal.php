	...
	<body>
		...
		<section id="contenedor">
			<div class="aa">
				...
				<div class="a2">
					<img src="img/cinco-lila.png" width="100%">
				</div>
			</div>
			<div class="bb">
				<div class="b1">
					<a href="5-u-naranja-0-bien.php"><img src="img/bt-naranja.jpg" width="26%"></a>
					<a href="5-u-lila-0-mal.php"><img src="img/bt-lila.jpg" width="26%"></a>
					<a href="5-u-rojo-0-mal.php"><img src="img/bt-rojo.jpg" width="26%"></a>
				</div>
				</div>
				...
				<div class="b2">
					...
					<audio controls autoplay width="20%" heigth="20%">
						<source src="audio/escoge-color-naranja-5.mp3">
					</audio>
					<!--<audio src="audio/1.mp3" preload="auto" controls></audio>-->
					</div>
				</div>
