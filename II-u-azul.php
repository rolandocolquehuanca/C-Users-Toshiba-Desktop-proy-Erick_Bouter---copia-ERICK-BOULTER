...
<html lang="es">
	...
	<body>
			...
			<div class="wrapper">
				<div class="logo">
					<div class="nom1">
						...
						echo "Elegiste el color AZUL ..." .$_SESSION['nombreUsuario'];
					?>
					</div>
					<!--<div class="nom2">
						<?php
		...
		<section id="contenedor">
			...
			<div class="bb">
				<div class="b1">
					<a href="#"onmousedown="bleep8.play()"><img src="img/bt-az-auto.png" width="30%"></a>					
					<a href="#"onmousedown="bleep9.play()"><img src="img/bt-az-gorra.png" width="30%"></a>					
					<a href="#"onmousedown="bleep10.play()"><img src="img/bt-az-pelota.png" width="30%"></a>					
					<a href="#"onmousedown="bleep11.play()"><img src="img/bt-az-polera.png" width="30%"></a>					
					<a href="#"onmousedown="bleep12.play()"><img src="img/bt-az-vestido.png" width="30%"></a>					
					<a href="#"onmousedown="bleep13.play()"><img src="img/bt-az-zapato.png" width="30%"></a>
				</div>
