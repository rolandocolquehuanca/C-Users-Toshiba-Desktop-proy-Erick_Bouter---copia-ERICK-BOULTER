...
<html lang="es">
	...
	<body>
			...
			<div class="wrapper">
				<div class="logo">
					<div class="nom1">
						...
						echo "Elegiste el color NARANJA ..." .$_SESSION['nombreUsuario'];
					?>
					</div>
					<!--<div class="nom2">
						<?php
		...
		<section id="contenedor">
			...
			<div class="bb">
				<div class="b1">
					<a href="#"onmousedown="bleep8.play()"><img src="img/bt-na-cinturon.png" width="30%"></a>					
					<a href="#"onmousedown="bleep9.play()"><img src="img/bt-na-deportivo.png" width="30%"></a>					
					<a href="#"onmousedown="bleep10.play()"><img src="img/bt-na-gorra.png" width="30%"></a>					
					<a href="#"onmousedown="bleep11.play()"><img src="img/bt-na-moto.png" width="30%"></a>					
					<a href="#"onmousedown="bleep12.play()"><img src="img/bt-na-pelota.png" width="30%"></a>					
					<a href="#"onmousedown="bleep13.play()"><img src="img/bt-na-zapato.png" width="30%"></a>
				</div>
