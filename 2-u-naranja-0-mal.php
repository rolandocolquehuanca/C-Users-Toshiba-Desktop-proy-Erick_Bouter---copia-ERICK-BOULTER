	...
	<body>
			...
			<div class="wrapper">
				<div class="logo">
					<div class="nom1">
						...
						echo "No es el color azul intenta nuevamente..." .$_SESSION['nombreUsuario'];
					?>
					</div>
					<!--<div class="nom2">
						<?php
		...
		<section id="contenedor">
			<div class="aa">
				...
				<div class="a2">
					<img src="img/dos-naranja.png" width="100%">
				</div>
			</div>
			<div class="bb">
				<div class="b1">
					<a href="2-u-naranja-0-mal.php"><img src="img/bt-naranja.jpg" width="26%"></a>
					<a href="2-u-azul-0-bien.php"><img src="img/bt-azul.jpg" width="26%"></a>
					<a href="2-u-verde-0-mal.php"><img src="img/bt-verde.jpg" width="26%"></a>
				</div>
				</div>
				...
				<div class="b2">
					...
					<audio controls autoplay width="20%" heigth="20%">
						<source src="audio/escoge-color-azul-2.mp3">
					</audio>
					<!--<audio src="audio/1.mp3" preload="auto" controls></audio>-->
					</div>
				</div>
