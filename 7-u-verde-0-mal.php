	...
	<body>
		...
		<section id="contenedor">
			<div class="aa">
				...
				<div class="a2">
					<img src="img/siete-verde.png" width="100%">
				</div>
			</div>
			<div class="bb">
				<div class="b1">
					<a href="7-u-verde-0-mal.php"><img src="img/bt-verde.jpg" width="26%"></a>
					<a href="7-u-amarillo-0-bien.php"><img src="img/bt-amarillo.jpg" width="26%"></a>
					<a href="7-u-lila-0-mal.php"><img src="img/bt-lila.jpg" width="26%"></a>
				</div>
				</div>
				...
				<div class="b2">
					...
					<audio controls autoplay width="20%" heigth="20%">
						<source src="audio/escoge-color-amarillo-7.mp3">
					</audio>
					<!--<audio src="audio/1.mp3" preload="auto" controls></audio>-->
					</div>
				</div>
